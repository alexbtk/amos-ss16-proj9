		...
		$.post("qeuryRequest", {
			...
			"timeframe" : 2
					...
					function(data) {
						...
						//alert(numbers[0]);
						//alert(numbers[1]);
						var plot2 = $.jqplot('newsChart', [[['negative news',(numbers[0]/(numbers[0]+numbers[1]))*100],['positive news',(numbers[1]/(numbers[0]+numbers[1]))*100]]], {
							grid: {
					            drawBorder: false, 
					            drawGridlines: false,
					            background: '#ffffff',
			...
			$.post("qeuryRequest", {
				...
				"timeframe" : 2
						...
						function(data) {
							...
							//alert(numbers[0]);
							//alert(numbers[1]);
							var plot2 = $.jqplot('newsChartO', [[['negative news',(numbers[0]/(numbers[0]+numbers[1]))*100],['positive news',(numbers[1]/(numbers[0]+numbers[1]))*100]]], {
								grid: {
						            drawBorder: false, 
						            drawGridlines: false,
						            background: '#ffffff',
