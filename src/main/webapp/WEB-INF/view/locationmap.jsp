...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/plugins/jvectormap/jquery-jvectormap-2.0.3.css"
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i
						...
						<ul class="treeview-menu">
							...
							<li><a href="${pageContext.request.contextPath}/index2.html"><i
					...
					<li><a
						href="${pageContext.request.contextPath}/documentation/index.html"><i
